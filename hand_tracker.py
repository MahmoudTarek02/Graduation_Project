...
_DEFAULT_MODEL_PATH = Path(HAND_LANDMARKER_MODEL_PATH)
...
class MediaPipeHandTracker(HandTrackerBase):
    ...
    def __init__(
        ...
        max_hands: int = BACK_HAND_MAX_HANDS,
        detection_confidence: float = BACK_HAND_DETECTION_CONFIDENCE,
        tracking_confidence: float = BACK_HAND_TRACKING_CONFIDENCE,
        use_fingertip: str = BACK_HAND_FINGERTIP,
    ):
